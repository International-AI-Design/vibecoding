...
echo "     International-AI-Design/animal-lovers-platform (the actual platform repo)"
echo "  6. Once added:"
echo "       gh repo clone International-AI-Design/animal-lovers-platform"
echo "       cd animal-lovers-platform && claude"
echo ""
